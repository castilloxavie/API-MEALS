...
export const RegisteruserSchema = z.object({
    ...
    password: z.string().min(8, {message:"The password must have a minimum of 8 characters"}),
...
export const validateLogin = (data) => {
    ...
    const {hasError, errorMessage, data:userData} = extactValidationErrorData(result)
